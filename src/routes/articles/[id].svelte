...
<article>
	<header>
		<h1 class="title">{article.frontmatter.icon} {article.frontmatter.title}</h1>
		<div class="subtitle">{article.frontmatter.subtitle}</div>
		<div class="meta">
			<div class="tags">
	...
	<footer>
		<div class="author">an article by <span class="name">Eunsoo Shin (esinx)</span></div>
	</footer>
</article>
