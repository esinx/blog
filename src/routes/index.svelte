...
<script>
  ...
  const toDisplayDate = date => new Date(date).toDateString();
</script>
    ...
    <div class="links">
      <a href="https://github.com/esinx" target="_blank">
        <svg
          ...
          <path
            ...
            1.258 0 00-.232.028l-.01.002-.004.002h-.003l.137.481-.137-.48a.5.5 0
            00-.32.276 3.12 3.12 0 00-.159 2.101A3.354 3.354 0 002 5.93c0
      ...
      <a href="https://twitter.com/e_sinx" target="_blank">
        <svg
          ...
          height="30">
          <path
            d="M14.977 1.467a.5.5 0 00-.87-.301 2.559 2.559 0 01-1.226.763A3.441
            3.441 0 0010.526 1a3.539 3.539 0 00-3.537 3.541v.44C3.998 4.75 2.4
            2.477 1.967 1.325a.5.5 0 00-.916-.048C.004 3.373-.157 5.407.604
            7.139 1.27 8.656 2.61 9.864 4.51 10.665 3.647 11.276 2.194 12 .5
            12a.5.5 0 00-.278.916C1.847 14 3.55 14 5.132 14h.048c4.861 0
            8.8-3.946
  ...
  <div id="articles">
    ...
    {#each articles as article}
      <a class="article" href={`/article/${article.slug}`}>
        ...
        <span class="date">{toDisplayDate(article.date)}</span>
        <span class="tags">
